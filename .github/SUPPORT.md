# Getting help with `QTExpTool`

Thank you for using `QTExpTool`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/QTExpTool`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/QTExpTool),
...
[search issues and pull requests](https://github.com/AliSajid/QTExpTool/issues)
